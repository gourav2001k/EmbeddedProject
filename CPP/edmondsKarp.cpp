...
bool BFS(vector<vector<int>> &graph, vector<int> &parent, vector<bool> &visited, int n, int s, int t) {
	queue<int> q;
...
int EdmondsKarp(vector<vector<pair<int, int>>> &adj, int n, int s, int t) {
...
int main(){
	...
	int max_flow = EdmondsKarp(adj, n, s, t);
